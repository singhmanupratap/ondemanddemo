$triggerInput = @{"Id"="d96163db-9031-4d3d-9147-02139cf6ed23";"SolutionName"="WebApplication1";"BuildTemplate"="";"Status"=2;"BuildId"="63";"PkgURL"="https://fcfnapp966e.blob.core.windows.net/builds/WebApplication1.zip?sv=2015-04-05&sr=c&sig=UOx0PPjyrcIS5N49Bgjbytev49Pw3DsmtmFs0pA1e4Y%3D&se=2017-11-08T17%3A52%3A29Z&sp=r";"DeploymentName"="manupsxtttz";"PresetAzureLocationName"="WestEurope";"PresetAzureAccountName"="";"PresetAzureSubscriptionName"="";"PresetAzureDirectoryName"="";"VmAdminPassword"=""};
...
#$global:rootPath =  "D:\home\site\wwwroot\BuildSolution\Solutions\"
